...
// 导出 Search 组件
export default function Search({ searchWidth = "256px", searchHeight = "40px", placeholder = "Search", searchType = "text", onChange }: searchProps) {
    ...
    return (
        <div className="relative" style={{ width: searchWidth, height: searchHeight }}>
            ...
            <input className="search-input w-full h-full pl-10 pr-10 rounded-lg border-2 border-solid placeholder:text-[#73767a] outline-none focus:border-origin-100 transition-colors duration-300"
